...
urlpatterns = [
    ...
    path(
        "project/<int:pk>/delete/", views.ProjectDelete.as_view(), name="project-delete"
    ),
    # Category URLs
    ...
    path(
        "costlimits/<int:pk>/update/",
        views.CostLimitUpdate.as_view(),
        name="costlimit-update",
    ),
    path(
        "costlimits/<int:pk>/delete/",
        views.CostLimitDelete.as_view(),
        name="costlimit-delete",
    ),
    # Payee URLs
